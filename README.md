...
React is a library for JS that simplifies alot with it, making components easier and is more user friendly than vanilla JS.
1. Describe component state.
Component state is the information needed by a variable in an application
1. Describe props.
props are information being passed to a function
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
side effects are unintended results in an application
